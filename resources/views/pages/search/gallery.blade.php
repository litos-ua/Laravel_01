...
@section('languageSelector')
    ...
    <div class="dropdown language-selector">
        ...
        <ul class="dropdown-menu" aria-labelledby="languageDropdown">
            ...
            <li><a class="dropdown-item" href="#" data-language="pl">Polish</a></li>
            <li><a class="dropdown-item" href="#" data-language="uk">Ukrainian</a></li>
        </ul>
    </div>
@endsection
...
//                    $filesGet = $picture->filename . '$' . $picture->title . '$' . $picture->category;
                       $filesGet = $picture->filename . '$' . $searchTerm . '$' . $vacCat
                @endphp



                <a href="{{ route('search/picture', ['currentFileName' => $filesGet]) }}">
                        <img class="img-fluid"
                             id="pic_of_gallery"
