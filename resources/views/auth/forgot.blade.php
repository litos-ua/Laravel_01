            ...
            <div class="bg-white w-96 shadow-xl rounded p-5">
                ...
                <form class="space-y-5 mt-5" method="POST" action="{{ route("forgot_process") }}">
                    ...
                    <a href="{{ route("login") }}" id = "exist_account"
                       class="font-medium text-blue-900 hover:bg-blue-300 rounded-md p-2">Remembered the password</a>
                    </div>

                    <button type="submit" id="forget-button" class="text-center w-full bg-blue-900 rounded-md text-white py-3 font-medium">Retrieve</button>
                </form>
            </div>
        </div>
    </div>
