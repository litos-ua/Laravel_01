...
{{--                    </div>--}}
                    ...
                    <div id="have_account">
                        <a href="{{ route("login") }}" id="exist_account"
                           class="font-medium text-blue-900 hover:bg-blue-300 rounded-md p-2">Sign In</a>
                    </div>

                    <button type="submit" id="signup-button"
                            class="text-center w-full bg-blue-900 rounded text-white py-3 font-medium">Sign Up
                    </button>
                </form>
            </div>
        </div>
